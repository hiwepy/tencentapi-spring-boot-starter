...
public class TencentTimAccountOperations extends TencentTimOperations {
	 ...
	 * @return
	 */
	public IMActionResponse aImport(String userId, String nickname, String avatar) {
	 ...
	 * @return
	 */
	public IMActionResponse aImport(String[] userIds) {
		Map<String, Object> requestBody = new ImmutableMap.Builder<String, Object>()
	 ...
	 * @return
	 */
	public IMActionResponse delete(String[] userIds) {
		Map<String, Object> requestBody = new ImmutableMap.Builder<String, Object>()
	 ...
	 * @return
	 */
	public IMActionResponse kick(String userId) {
		Map<String, Object> requestBody = new ImmutableMap.Builder<String, Object>()
